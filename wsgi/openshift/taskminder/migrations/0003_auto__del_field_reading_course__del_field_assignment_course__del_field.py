...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('taskminder_course', 'professor_id')

        # Adding M2M table for field professor on 'Course'
        m2m_table_name = db.shorten_name('taskminder_course_professor')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['taskminder.course'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.add_column('taskminder_reading', 'course',
                      self.gf('django.db.models.fields.related.OneToOneField')(unique=True, default='Course', to=orm['taskminder.Course']),
                      keep_default=False)
        ...
        db.add_column('taskminder_course', 'professor',
                      self.gf('django.db.models.fields.related.OneToOneField')(unique=True, default='prof', to=orm['taskminder.Professor']),
                      keep_default=False)

        # Removing M2M table for field professor on 'Course'
        db.delete_table(db.shorten_name('taskminder_course_professor'))
    ...
    models = {
        'taskminder.assignment': {
            ...
            'course': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['taskminder.Course']"}),
            'due_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.TimeField', [], {'blank': 'True', 'null': 'True', 'default': 'None'}),
